...
{
    public partial class nakitsil : Form
    {
        public nakitsil()
        {
            InitializeComponent();
        ...
        public void KayitSil()
        {
            ...
            {
                Form1.BaglantıAc();
                string Sorgu = "Delete from Nakit where ID=" + txtnakitsilID.Text;
                OleDbCommand SilKomut = new OleDbCommand(Sorgu, Form1.Baglanti);
                if (SilKomut.ExecuteNonQuery() == 1)
                    MessageBox.Show(txtnakitsilID.Text + "Kayıt Silindi", "Uyarı");
